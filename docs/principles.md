...
It’s not a collection of finished work—it's a place to grow notes, thoughts, and learnings over time.

## What this is
- **Digital Garden**: notes in progress. I can leave things unfinished and gradually improve them.
- **Open source**: anyone can read it (transparency + reference). I only publish what I’m comfortable sharing publicly.
